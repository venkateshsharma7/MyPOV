...
export default function Login() {
          ...
          >
            ...
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              <div style={{
                ...
                <span style={{
  fontFamily: "'DM Mono', monospace", // changed from Cinzel
  fontSize: "18px",
  letterSpacing: "4px",
  color: "#d4af37",
  ...
  MyPOV
              ...
              <h1 style={{
                ...
                Welcome back,<br />
                <em style={{ fontStyle: "italic", color: "rgba(212,175,55,0.85)" }}>cinephile.</em>
              </h1>
